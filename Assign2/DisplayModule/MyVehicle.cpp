...
using namespace System; // Console command
...
MyVehicle::MyVehicle(int* numData, double rangeX[], double rangeY[])
{
	this->numRanges = numData;
	this->rangeX = rangeX;
	this->rangeY = rangeY;
}

void MyVehicle::setLaser(int* numData, double rangeX[], double rangeY[])
{
	this->numRanges = numData;
	this->rangeX = rangeX;
	this->rangeY = rangeY;
